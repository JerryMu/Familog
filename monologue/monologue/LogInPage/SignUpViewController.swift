        ...
        if error != nil {
            ...
            Auth.auth().createUser(withEmail: email, password: password) { (result, err) in
                ...
                if err != nil {
                    ...
                    let user = ["email": email, "profileImageUrl": nil, "firstname": firstName, "lastname": lastName, "uid": currentUser, "age": nil, "bio" : nil, "postNumber" : 0, "familyId": nil] as [String : Any?]
